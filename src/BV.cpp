...
BV::BV(glm::dvec3& d1, glm::dvec3& d2, glm::dvec3& d3) {
...
void BV::Include(std::vector<BV*>& array, int l, int r) {
...
bool BV::HitBox(glm::dvec3& o, glm::dvec3& d) {
...
std::pair<glm::dvec3, bool> BV::rayIntersectsTriangle(glm::dvec3& p, glm::dvec3& d) {
